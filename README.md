...
* Reduce loading time, provide better ux
* Separate concerns/responsibilities
* DRY - don't repeat yourself; able to reuse components
* JavaScript necessary on the front-end

* Able to tell our code how we want our page to look in response to changes in data
...
## Project goals:
  ...
  front: https://cdn.bulbagarden.net/upload/a/a3/Spr_1b_001.png
  back: https://cdn.bulbagarden.net/upload/b/b9/Spr_b_g1_001.png
